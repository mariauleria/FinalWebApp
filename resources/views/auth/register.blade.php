...
{{--                        3. PHONE NUMBER--}}
                        <div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label text-md-end">{{ __('Nomor HP') }}</label>
...
{{--                        4. PRODI (Dropdown)--}}
                        <div class="row mb-3">
                            <label for="division_id" class="col-md-4 col-form-label text-md-end">{{ __('Prodi/Divisi') }}</label>
